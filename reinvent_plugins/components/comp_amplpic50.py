...
__all__ = ["AMPLPredictionModelpic50"]
...
from .amplscorer_pic50 import ampl_pred_model
...
target_col_name =  "pIC50"
working_directory = "/home/overhulsejm/reinvent4/REINVENT4/contrib/reinvent_plugins/components/ampl"
...
@add_tag("__component")
class AMPLPredictionModelpic50:
